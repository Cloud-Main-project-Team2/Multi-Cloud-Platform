...
from app import (
    aws_cloudfront_provisioning,
    aws_provisioning,
    aws_rds_provisioning,
    aws_s3_provisioning,
    azure_cdn_provisioning,
    azure_database_provisioning,
    azure_provisioning,
...
_RUNNERS: dict[tuple[str, str], ModuleType] = {
    ...
    ("azure", "sql_database"): azure_database_provisioning,
    ("azure", "cdn"): azure_cdn_provisioning,
